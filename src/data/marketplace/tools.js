export const academicTools = [
  ...
  },
  {
    ...
    description: 'Convert your research paper or document into a professional PowerPoint presentation. ₦2,000 per slide.',
    icon: 'Presentation',
    pricePerUse: 2000,
    category: 'generation',
    isAvailable: true,
  ...
  },
  {
    ...
    description: 'Find relevant academic papers and generate properly formatted citations. Basic search is FREE; Deep Search is ₦200 per search.',
    icon: 'BookOpen',
    pricePerUse: 0,
    category: 'research',
    isAvailable: true,
  ...
  },
  {
    ...
    description: 'Generate professional research questionnaires, surveys, and interview protocols tailored to your project topic and methodology.',
    icon: 'ClipboardList',
    pricePerUse: 2000,
    category: 'generation',
    isAvailable: true,
