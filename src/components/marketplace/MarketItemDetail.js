              ...
              <div className="space-y-6">
                {isPurchased ? (
                  <>
                    ...
                    <a href={`mailto:${isAdminItem ? 'w33writelab@gmail.com' : item.marketplace_sellers?.email_updates}`} className="flex items-center gap-4 p-4 bg-blue-50 rounded-3xl border border-blue-100 hover:bg-blue-100 transition-colors group">
                      ...
                      <div>
                        ...
                        <p className="text-zinc-900 font-black">{isAdminItem ? 'w33writelab@gmail.com' : item.marketplace_sellers?.email_updates}</p>
                      </div>
                    </a>
                  </>
                ) : (
