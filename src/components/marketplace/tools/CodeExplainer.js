      ...
      <div className="grid lg:grid-cols-2 gap-8 md:gap-12">
        ...
        <div className="bg-white border border-[#e5e7eb] rounded-[32px] md:rounded-[48px] p-6 md:p-10 shadow-sm flex flex-col h-[500px] md:h-[600px]">
          ...
          <textarea 
            ...
            className="flex-1 overflow-y-auto custom-scrollbar bg-zinc-900 text-emerald-400 font-mono text-xs md:text-sm rounded-[24px] md:rounded-[32px] border-4 border-zinc-800 p-6 md:p-8 focus:border-emerald-500/30 focus:outline-none transition-all resize-none shadow-2xl"
          />
        ...
        <div className="bg-white border border-[#e5e7eb] rounded-[32px] md:rounded-[48px] p-6 md:p-10 shadow-sm flex flex-col h-[500px] md:h-[600px]">
          <div className="flex justify-between items-center mb-6 md:mb-8 shrink-0">
            <div className="flex items-center gap-3 md:gap-4">
              ...
              <div>
                <h2 className="text-lg md:text-xl font-black text-[#111827] uppercase tracking-tighter">Logic Breakdown</h2>
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar bg-zinc-900 rounded-[24px] md:rounded-[32px] p-6 md:p-8 text-zinc-300 font-medium leading-relaxed prose prose-invert prose-emerald max-w-none text-sm md:text-base">
            {explanation ? (
              ...
              <div className="h-full flex flex-col items-center justify-center text-zinc-600 italic">
                <Terminal className="w-10 h-10 md:w-12 md:h-12 mb-4 opacity-10" />
