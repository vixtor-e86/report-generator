          ...
          <div className="flex flex-col lg:flex-row gap-12">
              ...
              <div className="lg:w-96 space-y-8">
                  ...
                  <div className="bg-white p-8 rounded-[40px] border border-slate-100 shadow-xl">
                      <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-600 mb-6">Export Package</h4>
                      <div className="space-y-4">
                          ...
                          <button onClick={() => { setSlides([]); setInput(''); }} className="w-full text-[10px] font-black text-slate-600 uppercase tracking-widest hover:text-red-500 transition-colors">Create New Project</button>                      </div>
                  </div>
              </div>
          </div>
      </div>
            ...
            <div className="space-y-3 mb-6">
                {customOutline.map((item, idx) => (
                    <div key={idx} className="flex items-center justify-between bg-slate-50 p-4 rounded-2xl border border-slate-100 group">
                        <div className="flex items-center gap-4">
                            <span className="w-8 h-8 bg-white rounded-lg flex items-center justify-center text-[10px] font-black text-slate-600 shadow-sm border border-slate-100">{idx + 1}</span>
            ...
            <div className="flex justify-between items-center mb-8 shrink-0">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500 font-medium">Research or technical text</p>
                    </div>
                </div>
        ...
        <div className="space-y-8">
            ...
            <div className="bg-white border border-slate-200 rounded-[40px] p-8 shadow-sm">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-600">Slide Count Range</h3>
                </div>
                <div className="grid grid-cols-2 gap-2">
                    {['8-12', '12-18', '18-25', '25-35'].map(range => (
                        <button
                            ...
                            className={`py-3 rounded-xl border-2 font-black text-xs transition-all ${slideCountRange === range ? 'border-zinc-900 bg-zinc-900 text-white shadow-lg' : 'border-slate-50 bg-slate-50 text-slate-600 hover:border-slate-200'}`}
                        >
                            {range} SLIDES
                        </button>
                    ))}
            ...
            <div className="bg-white border border-slate-200 rounded-[40px] p-8 shadow-sm">
                <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-600 mb-8">Technical Visuals</h3>
                <div onClick={() => fileInputRef.current.click()} className="border-2 border-dashed border-slate-100 rounded-[28px] p-8 flex flex-col items-center justify-center gap-4 cursor-pointer hover:border-zinc-900 hover:bg-slate-50 transition-all group">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-600">Add Figures (Max 5)</p>
                </div>
                    ...
                    {uploadedImages.map(img => (
                        <div key={img.id} className="bg-slate-50 rounded-2xl p-4 flex gap-4 border border-slate-100 relative group">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-[9px] text-zinc-600 font-bold mt-1 uppercase">Required Key</p>
                            </div>
                            <button onClick={() => removeImage(img.id)} className="absolute -top-2 -right-2 w-6 h-6 bg-white rounded-full shadow-md flex items-center justify-center text-slate-600 hover:text-red-500 opacity-0 group-hover:opacity-100 transition-opacity border border-slate-100"><X className="w-3 h-3" /></button>
                        </div>
                    ))}
                </div>
            </div>
