      ...
      <motion.div initial={{ scale: 0.98, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="relative bg-white md:rounded-[40px] shadow-2xl w-full max-w-7xl overflow-hidden flex flex-col h-full md:h-[85vh] md:max-h-[750px]">
        <div className="p-5 md:p-8 flex justify-between items-center bg-white border-b border-slate-100 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div><h2 className="text-base md:text-xl font-black text-slate-900 leading-tight">Academic Humanizer</h2><p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">High-End Research System</p></div>
          </div>
              ...
              <div className="w-full max-w-md flex flex-col h-full max-h-[600px] space-y-6">
                <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm shrink-0">
                  <div className="flex justify-between items-end mb-2">
                    <div><p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Word Usage</p><p className="text-sm font-black text-slate-900">{localUsage.toLocaleString()} / {wordsLimit.toLocaleString()}</p></div>
                ...
                <div className="text-center shrink-0"><h3 className="text-xl md:text-2xl font-black text-slate-900">Choose Chapter</h3><p className="text-sm text-slate-500 mt-1">Select the chapter you want to optimize for academic bypassing.</p></div>
