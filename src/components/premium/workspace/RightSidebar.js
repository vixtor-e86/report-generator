        ...
        {activeTab === 'tools' ? (
          <div className="tools-list">
            <div className="tool-section">
              ...
              <div id="step-visuals"><ToolItem icon={<Icons.Image style={{ color: '#6366f1' }} />} title="Diagram & Image Studio" desc="Create diagrams and illustrations." onClick={onVisualToolsClick} action="Use" /></div>
