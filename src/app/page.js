...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center">
          <div className="inline-block bg-indigo-100 text-indigo-700 px-4 py-2 rounded-full text-sm font-semibold mb-6">
            🎓 Built for Nigerian Engineering Students
          </div>
          
          <h1 className="text-5xl md:text-6xl font-extrabold text-gray-900 leading-tight mb-6">
            Generate Your Engineering<br/>
            <span className="text-indigo-600">Project Report in Minutes</span>
          </h1>
          
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-10 leading-relaxed">
            Stop spending 40+ hours writing project documentation manually. Our AI generates 
            professional, properly formatted 5-chapter engineering reports with accurate citations 
            in just minutes.
          </p>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-8">
            ...
            <a 
              href="#pricing"
              className="bg-white text-indigo-600 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-gray-50 shadow-lg transition border-2 border-indigo-600"
            >
              View Pricing
            </a>
          </div>
      ...
      <div id="features" className="bg-gray-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Generate your complete engineering report in 3 simple steps</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {/* Step 1 */}
            <div className="text-center">
              <div className="bg-indigo-600 w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg">
                <span className="text-3xl font-bold text-white">1</span>
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Enter Project Details</h3>
              <p className="text-gray-600 text-lg leading-relaxed">
                Provide your project title, engineering department, components used (Arduino, sensors, etc.), 
                and a brief description of what your project does.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                Our AI writes each chapter professionally—Introduction, Literature Review, Methodology, 
                Results, and Conclusion. Review and approve each chapter before moving to the next.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                Export your complete report as PDF or editable Word document (DOCX), ready for 
                submission to your university with proper formatting and citations.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-2xl p-8 hover:border-indigo-300 transition">
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">1 complete report (lifetime)</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  <span className="text-gray-700">Basic AI quality</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  <span className="text-gray-700">Upload 2 images</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  <span className="text-gray-700">Standard 5-chapter template</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                ...
                <li className="flex items-start gap-3 opacity-50">
                  ...
                  <span className="text-gray-500">No chapter regeneration</span>
                </li>
                <li className="flex items-start gap-3 opacity-50">
                  <svg className="w-6 h-6 text-gray-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12"></path>
                  </svg>
                  <span className="text-gray-500">No Word document export</span>
                </li>
              </ul>
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-white border-2 border-indigo-500 rounded-2xl p-8 relative transform hover:scale-105 transition shadow-xl">
              ...
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">Enhanced AI quality (Gemini Pro)</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  <span className="text-gray-700">Upload up to 5 images</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  <span className="text-gray-700">Unlimited chapter regeneration</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  <span className="text-gray-700">All 3 templates available</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  <span className="text-gray-700">Word document (DOCX) export</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  <span className="text-gray-700">30-day edit access</span>
                </li>
              </ul>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-2xl p-8 hover:border-indigo-300 transition">
              ...
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">Premium AI (Claude 3.5 Sonnet)</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">Custom template upload</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  <span className="text-gray-700">Priority generation (no queue)</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  <span className="text-gray-700">90-day edit access</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
      ...
      {/* What is IEEE Citations Section */}
          ...
          <div className="bg-white rounded-2xl p-10 shadow-lg">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 text-lg leading-relaxed mb-4">
                <span className="font-bold text-indigo-600">IEEE (Institute of Electrical and Electronics Engineers)</span> 
                is the standard citation format used in engineering, technology, and computer science fields worldwide.
              </p>
              ...
              <div className="bg-indigo-50 border-l-4 border-indigo-600 p-6 my-6 rounded">
                ...
                <p className="text-gray-700 mb-2">
                  &quot;The Arduino Uno operates at 5V and features an ATmega328P microcontroller <span className="font-bold text-indigo-600">[1]</span>. 
                  Temperature sensors like the DHT11 provide accurate readings for IoT applications <span className="font-bold text-indigo-600">[2]</span>.&quot;
                </p>
                <p className="text-gray-600 text-sm mt-4 italic">Then at the end of your report, you&apos;ll have:</p>
                <p className="text-gray-700 text-sm mt-2">
                  <span className="font-bold">[1]</span> Arduino, &quot;Arduino Uno Rev3,&quot; Arduino Documentation, 2023.<br/>
                  <span className="font-bold">[2]</span> D-Robotics, &quot;DHT11 Humidity & Temperature Sensor Datasheet,&quot; 2020.
                </p>
              </div>

              <p className="text-gray-700 text-lg leading-relaxed mb-4">
                <span className="font-bold">Why it matters:</span> Nigerian universities require proper citations in project reports. 
                Our AI automatically adds these citations as it generates your report, ensuring your work meets academic standards 
                and avoids plagiarism issues.
              </p>
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-indigo-800 py-20">
        <div className="max-w-4xl mx-auto text-center px-4">
          <h2 className="text-4xl font-bold text-white mb-6">
            Ready to Save 40+ Hours of Writing?
          </h2>
          <p className="text-indigo-100 text-xl mb-10 leading-relaxed">
            Join hundreds of engineering students who&apos;ve generated professional reports in minutes. 
            Start with 1 free report—no credit card required.
          </p>
          <div className="w-full max-w-sm mx-auto">
            <GoogleAuthButton />
          </div>
          
          <p className="text-indigo-200 text-sm mt-6">✓ No signup required to try • ✓ Works with your university&apos;s format</p>
        </div>
      </div>
