      ...
      <div className="max-w-4xl mx-auto px-6 py-20">
        ...
        <div className="space-y-24">
          ...
          <section className="space-y-6">
            ...
            <div className="text-slate-600 leading-relaxed space-y-4 font-medium">
              <p>If you have questions or comments about this notice, you may email us at <a href="mailto:w33writelab@gmail.com" className="text-blue-600 font-bold hover:underline">w33writelab@gmail.com</a> or contact us by post at:</p>
