    ...
    <div className="min-h-screen bg-[#f8f9fc] font-sans">
      ...
      <div className="max-w-4xl mx-auto px-6 py-20">
        ...
        <div className="mt-32 pt-12 border-t border-slate-200 text-center">
          ...
          <p className="text-slate-500 font-medium">For inquiries: <a href="mailto:w33writelab@gmail.com" className="text-indigo-600 font-bold hover:underline">w33writelab@gmail.com</a></p>
        </div>
      </div>
    </div>
  );
