    ...
    <div className="space-y-8 pb-20">
      ...
      {selectedProject && (
        <div className="fixed inset-0 z-[120] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-[40px] shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col animate-in zoom-in-95 duration-200">
             {/* Modal Header */}
             <div className="p-8 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mt-1">Ref: {selectedProject.id}</p>
                    </div>
                </div>
                    ...
                    <div className="md:col-span-2 space-y-8">
                        <section>
                            <h3 className="text-[11px] font-black text-slate-900 uppercase tracking-widest mb-4 flex items-center gap-2">
                                <span className="w-1.5 h-1.5 bg-blue-600 rounded-full" /> Project Abstract
                            </h3>
                        ...
                        <section>
                            <h3 className="text-[11px] font-black text-slate-900 uppercase tracking-widest mb-4 flex items-center gap-2">
                                <span className="w-1.5 h-1.5 bg-indigo-600 rounded-full" /> Chapter 1 Full Preview
                            </h3>
                            <div className="bg-slate-50 rounded-3xl p-6 text-sm text-slate-600 leading-relaxed font-medium whitespace-pre-wrap max-h-96 overflow-y-auto border border-slate-100 shadow-inner">
                                {selectedProject.chapter_1_preview}
                            </div>
                        </section>
                    ...
                    <div className="space-y-6">
                        <div className="bg-zinc-900 rounded-[32px] p-6 text-white shadow-xl">
                            ...
                            <div className="space-y-4">
                                <div>
                                    <p className="text-[9px] font-black text-zinc-600 uppercase">Type</p>
             ...
             {selectedProject.status === 'pending' && (
                <div className="p-8 border-t border-slate-100 bg-slate-50/50 flex gap-4">
                    ...
                    >
                        {processing ? '...' : 'Verify & Push to Market'}
                    </button>
                </div>
             )}
          </div>
