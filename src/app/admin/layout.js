...
export default function AdminLayout({ children }) {
  ...
  const [sidebarStats, setSidebarStats] = useState({ payments: 0, referrals: 0, sellers: 0, marketPayouts: 0, blueprints: 0 });
  ...
  useEffect(() => {
    ...
    // Poll for stats every 60 seconds
  ...
  const platformNav = [
    ...
    { name: 'Payments', path: '/admin/transactions', icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z', badge: sidebarStats.payments },
    ...(!isSupportRole ? [{ name: 'Referrals', path: '/admin/transactions/payouts', icon: 'M3 10h18M7 15h1m4 0h1m4 0h1m-7 4h12a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z', badge: sidebarStats.referrals }] : []),
    { name: 'Users', path: '/admin/users', icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z' },
    ...(!isSupportRole ? [
      { name: 'Topics', path: '/admin/topics', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253' },
  ...
  const marketplaceNav = [
    ...
    { name: 'Activities', path: '/admin/marketplace/activities', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
    { name: 'Sellers', path: '/admin/marketplace/sellers', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z', badge: sidebarStats.sellers },
    { name: 'Blueprints', path: '/admin/marketplace/projects', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10', badge: sidebarStats.blueprints },
    { name: 'Ebooks', path: '/admin/marketplace/ebooks', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253' },
    ...
    ...(!isSupportRole ? [
      { name: 'Seller Payouts', path: '/admin/marketplace/payouts', icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z', badge: sidebarStats.marketPayouts },
        ...
        `}>
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar px-4 py-6 space-y-8">
                ...
                {platformNav.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      className={`flex items-center justify-between gap-3 px-3 py-2 rounded-lg text-xs font-bold transition-all duration-200 ${
            ...
            <div>
              ...
              <nav className="space-y-1">
                <Link href="/admin/notifications" className={`flex items-center gap-3 px-3 py-2 rounded-lg text-xs font-bold ${pathname === '/admin/notifications' ? 'bg-slate-700 text-white' : 'hover:bg-slate-800'}`}>
