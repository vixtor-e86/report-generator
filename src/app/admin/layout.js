...
export default function AdminLayout({ children }) {
  ...
  const platformNav = [
    ...
    { name: 'Referrals', path: '/admin/transactions/payouts', icon: 'M3 10h18M7 15h1m4 0h1m4 0h1m-7 4h12a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z', badge: sidebarStats.referrals },
