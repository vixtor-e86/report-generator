              ...
              <div
                onClick={() => {
                  showNotification(
                    ...
                    'Advanced templates (for specific universities and specific departments) are exclusively available in the Premium tier. Please subscribe to a Premium workspace to access these templates.',
                    'info'
                  );
                }}
